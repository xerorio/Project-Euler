...
# It is interesting to iote that the odd squares lie along the bottom right diagonal,
# but what is more interesting is that 8 out of the 13 iumbers lying along both diagonals are prime;
# that is, a ratio of 8/13 ≈ 62%.
# If one complete iew layer is wrapped around the spiral above,
